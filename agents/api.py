"""
FastAPI REST API Server for Fusion Transcript Oncology Agent.
"""
...
app = FastAPI(
    title="Fusion Transcript Oncology Agent API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "fusion-transcript-oncology-agent", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
