"""
Clinical Algorithmic Engine & Guideline Rules for FusionMind: RNA-Seq & NGS Oncogenic Gene Fusion Actionability Classifier.
Domain: Genomics
Standard: ESMO ESCAT Scale & ACMG / AMP 2015
"""
import math
...
class ClinicalDomainEngine:
    GUIDELINE = "ESMO ESCAT Scale & ACMG / AMP 2015"
    ...
    def evaluate_primary_index(cls, value: float) -> Optional[Dict[str, Any]]:
        if value > cls.PRIMARY_BASELINE_LIMIT:
            return {
                ...
                "finding": f"Observed value ({value:.2f}) exceeds ESMO ESCAT Scale & ACMG / AMP 2015 clinical baseline limit ({cls.PRIMARY_BASELINE_LIMIT:.1f}).",
    ...
    def evaluate_biomarker_concordance(cls, status_flag: str, biomarkers: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        if "DISCORDANT" in status_upper or "EQUIVOCAL" in status_upper or "MUTANT" in status_upper:
            return {
                ...
                "recommendation": f"Order reflex confirmatory testing per ESMO ESCAT Scale & ACMG / AMP 2015 clinical recommendations.",
            }
        return None
