"""
Command-Line Interface for FusionMind: RNA-Seq & NGS Oncogenic Gene Fusion Actionability Classifier.
"""
import argparse
import csv
import json
...
def main(argv=None):
    ...
    if args.command == "audit":
        ...
        print(f"  Domain: Genomics | Standard: ESMO ESCAT Scale & ACMG / AMP 2015")
