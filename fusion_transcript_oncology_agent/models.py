"""
Clinical Data Models & Enums for FusionMind: RNA-Seq & NGS Oncogenic Gene Fusion Actionability Classifier.
Domain: Genomics
...
class AgentAlert:
    ...
    guideline_citation: str = "ESMO ESCAT Scale & ACMG / AMP 2015"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
