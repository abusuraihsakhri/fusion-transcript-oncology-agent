"""
FastAPI REST Application & Webhooks for FusionMind: RNA-Seq & NGS Oncogenic Gene Fusion Actionability Classifier.
"""
...
def create_app():
    try:
        ...
        @app.get("/health")
        def health():
            return {"status": "HEALTHY", "system": "fusion-transcript-oncology-agent", "domain": "Genomics", "version": "2.0.0-PRO"}
