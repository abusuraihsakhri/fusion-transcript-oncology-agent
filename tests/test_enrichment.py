"""
Automated Pytest for fusion-transcript-oncology-agent Enrichment Modules.
"""
import sys
...
from enrichment import (
    OverviewEngine,
    ClinicalTrialMatchingWithEligibilityPrescreeningEngine,
    GoalEngine,
    DataModelChangesEngine,
    NewModuleEngine,
    AgentChangesEngine,
    IdentifyScreeningBarriersEngine,
    ApiChangesEngine,
    FusiontranscriptoncologyagentEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = FusiontranscriptoncologyagentEnrichmentSuite()
